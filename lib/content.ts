...
export const siteConfig = {
  name: "The Leader's Table",
  tagline: "Pull up a chair, the best conversations happen here.",
  description: "Your go-to source for practical and inspiring leadership tips. Join 161,812+ professionals elevating their leadership journey.",
  url: "https://theleaderstable.xyz",
  linkedIn: "https://www.linkedin.com/company/the-leaders-table",
  followers: "161,812",
  followersAggregated: "+160k",
  followersTagline: "leaders elevating their leadership",
  email: "hello@theleaderstable.xyz",
};
...
export const pillars = [
  {
    title: "Leadership",
    description: "Master the art of inspiring and guiding others toward shared goals.",
    icon: "compass",
    color: "navy",
  },
  {
    title: "Teams",
    description: "Build high-performing teams that collaborate effectively.",
    icon: "users",
    color: "accent",
  },
  {
    title: "Strategy",
    description: "Make decisions that drive organizational success.",
    icon: "target",
    color: "navy",
  },
  {
    title: "Communication",
    description: "Connect authentically and influence with clarity.",
    icon: "message",
    color: "accent",
  },
];
...
## Bringing Presence to the Interview

Building executive presence matters long before you become a manager. If you're preparing for interviews, these same principles apply. Learn the fundamentals of how to project confidence and communication in [our interview preparation guide](https://howtofindajob.org/resources/interview-prep-checklist-24-hours).

---

*Developing your leadership presence? Join 161,812+ professionals at The Leader's Table for weekly insights on leading with impact.*
    `,
  },
  {
...
1. **Physical readiness**: Your body is awake and energized
2. **Mental clarity**: Your mind is focused, not scattered
3. **Priority alignment**: You know what matters today
4. **Emotional grounding**: You're centered, not reactive
...
1. **Start minimal**: Sleep, movement, and priority review. That's it.
2. **Add gradually**: Once the basics are locked in, experiment with additions
3. **Track what works**: Notice which mornings lead to great days
4. **Protect it**: Treat your morning routine as non-negotiable as an important meeting
...
*Lead with intention from the first hour. Join 161,812+ professionals at The Leader's Table.*
    `,
  },
  {
...
*Navigate the complexities of leadership presence. Join 161,812+ professionals at The Leader's Table for insights on building your influence.*
    `,
  },
  {
    slug: "five-leadership-styles",
    title: "The 5 Leadership Styles and When to Use Each",
    excerpt: "Understanding different leadership approaches helps you adapt your style to any situation. Learn when to be directive, participative, or transformational.",
    category: "Leadership",
    readTime: "6 min read",
...
2. What does this person or team need from me right now?
3. What will create the best outcome for everyone involved?
...
*Want to deepen your leadership practice? Follow The Leader's Table for daily insights from experienced executives and coaches.*
  ...
  {
    slug: "feedback-that-changes-behavior",
    title: "How to Give Feedback That Actually Changes Behavior",
    excerpt: "Most feedback fails because it's too vague or too harsh. Learn the framework that makes your feedback actionable and well-received.",
    category: "Communication",
    readTime: "7 min read",
...
1. **Model vulnerability:** Ask for feedback on your own leadership first.
2. **Normalize it:** Make feedback part of regular conversations, not just annual reviews.
3. **Celebrate growth:** Recognize when people act on feedback and improve.
4. **Make it safe:** Respond gracefully when receiving feedback, even when it stings.
...
*Improve how you give and receive feedback. Join 161,812+ professionals at The Leader's Table.*
  ...
  {
    slug: "building-trust-remote-teams",
    title: "Building Trust in Remote Teams",
    excerpt: "Remote work requires intentional trust-building. Discover proven strategies for creating psychological safety when you can't be in the same room.",
    category: "Teams",
    readTime: "8 min read",
...
*Lead with intention, wherever your team is located. Follow The Leader's Table for more insights.*
  ...
  },
  {
    ...
    excerpt: "Leaders make hundreds of decisions daily. Learn frameworks to make better choices faster, even under uncertainty.",
    category: "Strategy",
    readTime: "7 min read",
...
*Sharpen your strategic thinking. Join The Leader's Table community.*
    `,
  },
  {
    slug: "managing-up",
    title: "Managing Up: How to Lead Your Boss",
    excerpt: "Your relationship with your manager shapes your career. Learn how to influence upward effectively while staying authentic.",
    category: "Leadership",
    readTime: "6 min read",
...
`,
  ...
  {
    slug: "psychological-safety-team-performance",
    title: "Psychological Safety: The Foundation of High-Performing Teams",
    excerpt: "Psychological safety isn't a nice-to-have culture initiative. It's the core condition that determines whether your team will speak up, admit mistakes, take risks, and ultimately perform at their best. Here's how to build it.",
    category: "Teams",
    readTime: "8 min read",
...
**Wrong response**: "How did this happen? Who caused this?"
**Right response**: "Thanks for catching this early. Help me understand what went wrong."
...
**Don't**: "That was a stupid mistake. You're better than that."
**Do**: "That specific approach didn't work. Here's what might work better. You're good at learning from feedback."
...
export const guides = [
  {
    slug: "first-time-manager-handbook",
    title: "The First-Time Manager's Complete Handbook",
    excerpt: "Everything you need to know when stepping into your first management role. From mindset shifts to practical skills.",
    category: "Leadership",
...
2. Clearly communicate the outcome needed
3. Provide context (the why, not just the what)
4. Define decision-making authority
5. Set check-in points
6. Get out of the way
7. Recognize the work publicly
...
- [ ] Learn team dynamics and history
- [ ] Build relationship with your manager
- [ ] Identify quick wins
...
- [ ] Establish your leadership rhythms
...
*Your leadership journey starts here. The Leader's Table is your partner every step of the way.*
  ...
  },
  {
    ...
    excerpt: "What separates good teams from exceptional ones? Learn the research-backed strategies for creating teams that consistently deliver outstanding results.",
    category: "Teams",
...
export const glossaryTerms = [
  {
    ...
    definition: "A leadership philosophy where the primary goal of the leader is to serve others. Servant leaders prioritize the growth, well-being, and empowerment of their team members, creating environments where people can develop and perform at their best.",
    keyPrinciples: [
      "Put team members' needs first",
    ...
    examples: [
      "A manager who asks 'What obstacles can I remove for you?' in every one-on-one",
      "A leader who advocates for team members' career growth, even when it means losing them",
      "An executive who handles administrative tasks to free up the team's time for meaningful work",
    ],
    relatedTerms: ["emotional-intelligence", "psychological-safety", "delegation"],
  },
  {
    term: "emotional-intelligence",
    title: "Emotional Intelligence",
    definition: "The ability to recognize, understand, manage, and effectively use emotions in yourself and others. In leadership, emotional intelligence enables better communication, conflict resolution, and team dynamics.",
    keyPrinciples: [
    ...
    examples: [
      "Recognizing when you're frustrated and taking a moment before responding to a challenging email",
      "Reading the room in a meeting and adjusting your approach based on team energy",
      "Having a difficult conversation with empathy while still maintaining clear expectations",
    ],
    relatedTerms: ["servant-leadership", "psychological-safety", "one-on-one-meetings"],
  },
  {
    term: "delegation",
    title: "Delegation",
    definition: "The process of assigning responsibility and authority to team members to complete specific tasks or projects. Effective delegation develops team capabilities while allowing leaders to focus on their highest-impact work.",
    keyPrinciples: [
    ...
    relatedTerms: ["servant-leadership", "one-on-one-meetings", "psychological-safety"],
  },
  {
    term: "one-on-one-meetings",
    title: "1:1 Meetings",
    definition: "Regular, scheduled conversations between a manager and each of their direct reports. These meetings are primarily for the team member's benefit, covering their priorities, obstacles, feedback, and development.",
    keyPrinciples: [
    ...
    relatedTerms: ["delegation", "emotional-intelligence", "psychological-safety"],
  },
  {
    term: "psychological-safety",
    title: "Psychological Safety",
    definition: "A shared belief that the team is safe for interpersonal risk-taking. Team members feel confident they won't be punished, humiliated, or rejected for speaking up with questions, concerns, mistakes, or new ideas.",
    keyPrinciples: [
    ...
    relatedTerms: ["servant-leadership", "emotional-intelligence", "one-on-one-meetings"],
  },
];
