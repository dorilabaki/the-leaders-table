          ...
          <StaggerContainer className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {contactMethods.map((method) => (
              <StaggerItem key={method.title}>
                ...
                >
                  <div className="w-16 h-16 bg-navy-900 rounded-xl flex items-center justify-center mx-auto mb-6 group-hover:bg-accent-500 transition-colors" aria-hidden="true">
